...
- Secret/API key/token có bị hardcode trong code không? Có dùng `dotenv`/secret manager thay vì hardcode không?
...
- Có gọi API/DB lặp không cần thiết có thể cache không?
...
- Tên biến/hàm/module có rõ ràng, theo convention dự án không?
...
- Test (Jest/Mocha) có được thêm hoặc cập nhật không? Có bao gồm cả happy path và error path không?
